...
TYPE PTRS
  ...
  INTEGER (KIND=JPIM) :: IPTR    = -HUGE (1_JPIM)
  INTEGER (KIND=JPIM) :: IPTR_NS = -HUGE (1_JPIM)
  CHARACTER*16 :: CLNAME = ''
END TYPE
...
TYPE PTRG
  REAL (KIND=JPRB), POINTER :: P (:,:) => NULL ()
  INTEGER (KIND=JPIM) :: ITYPE   = 0
  INTEGER (KIND=JPIM) :: IVSET   = -HUGE (1_JPIM)
  INTEGER (KIND=JPIM) :: IRANK_L = -HUGE (1_JPIM)
  INTEGER (KIND=JPIM) :: IRANK_G = -HUGE (1_JPIM)
  CHARACTER*16 :: CLNAME = ''
END TYPE
