...
YLGP_U    = GREP_G2S (YDGP, PGTF=ZGTF, KTYPE=NTYPE_U   , KVSET=MYSETV)
YLGP_V    = GREP_G2S (YDGP, PGTF=ZGTF, KTYPE=NTYPE_V   , KVSET=MYSETV)
YLGP_S    = GREP_G2S (YDGP, PGTF=ZGTF, KTYPE=NTYPE_S   , KVSET=MYSETV)
YLGP_U_EW = GREP_G2S (YDGP, PGTF=ZGTF, KTYPE=NTYPE_U_EW, KVSET=MYSETV)
YLGP_V_EW = GREP_G2S (YDGP, PGTF=ZGTF, KTYPE=NTYPE_V_EW, KVSET=MYSETV)
YLGP_S_EW = GREP_G2S (YDGP, PGTF=ZGTF, KTYPE=NTYPE_S_EW, KVSET=MYSETV)
YLGP_S_NS = GREP_G2S (YDGP, PGTF=ZGTF, KTYPE=NTYPE_S_NS, KVSET=MYSETV)
