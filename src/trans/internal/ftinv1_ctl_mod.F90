...
YLGP_VOR  = GREP (NPTR_VOR )
YLGP_DIV  = GREP (NPTR_DIV )
YLGP_U    = GREP (NPTR_U   )
YLGP_V    = GREP (NPTR_V   )
YLGP_S    = GREP (NPTR_S   )
YLGP_U_EW = GREP (NPTR_U_EW)
YLGP_V_EW = GREP (NPTR_V_EW)
YLGP_S_EW = GREP (NPTR_S_EW)
YLGP_S_NS = GREP (NPTR_S_NS)
...
WRITE (100+MYPROC, '(A8," ",A8," ",A8," ",A8," ",A8," ",A8)') "", "IRANK_G", &
     & "IRANK_L", "IVSET", "KIND"
DO J = 1, SIZE (YDGP)
  WRITE (100+MYPROC, '(I8," ",I8," ",I8," ",I8," ",I8," ",I8," ",L1)') J, YDGP (J)%IRANK_G, &
       & YDGP (J)%IRANK_L, YDGP (J)%IVSET, YDGP (J)%KIND, IVSET (J), YDGP (J)%IVSET == IVSET (J)
ENDDO

CALL FLUSH (100+MYPROC)
...
FUNCTION GREP (KIND) RESULT (YLGP)
