...
REAL(KIND=JPRB), POINTER :: ZCOMBUFS(:,:)
REAL(KIND=JPRB), POINTER :: ZCOMBUFR(:,:)
...
CALL MPL_ALLOCATE_INIT (500_8 * 1024_8 ** 2_8)

CALL MPL_ALLOCATE (ZCOMBUFS, UBOUNDS=[KSENDCOUNT,KNSEND], LBOUNDS=[-1,0])
CALL MPL_ALLOCATE (ZCOMBUFR, UBOUNDS=[KRECVCOUNT,KNRECV], LBOUNDS=[-1,0])
...
CALL MPL_DEALLOCATE (ZCOMBUFS)
CALL MPL_DEALLOCATE (ZCOMBUFR)
