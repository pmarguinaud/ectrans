...
CALL MPL_HEAP%ALLOCATE (ZCOMBUFS, UBOUNDS=[KSENDCOUNT,KNSEND], LBOUNDS=[-1,0])
CALL MPL_HEAP%ALLOCATE (ZCOMBUFR, UBOUNDS=[KRECVCOUNT,KNRECV], LBOUNDS=[-1,0])
...
CALL MPL_HEAP%DEALLOCATE (ZCOMBUFS)
CALL MPL_HEAP%DEALLOCATE (ZCOMBUFR)
