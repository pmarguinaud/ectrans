...
SUBROUTINE INV_TRANS1_CTL(KF_UV_G,KF_SCALARS_G,KF_GP,KF_FS,KF_OUT_LT,&
 ...
 & YDGP_VOR,YDGP_DIV,YDGP_U,YDGP_V,YDGP_S,YDGP_S_NS,YDGP_U_EW,YDGP_V_EW,YDGP_S_EW,YDGP)
...
TYPE (PTR2D), OPTIONAL :: YDGP_VOR  (:)
TYPE (PTR2D), OPTIONAL :: YDGP_DIV  (:)
TYPE (PTR2D), OPTIONAL :: YDGP_U    (:)
TYPE (PTR2D), OPTIONAL :: YDGP_V    (:)
TYPE (PTR2D), OPTIONAL :: YDGP_S    (:)
TYPE (PTR2D), OPTIONAL :: YDGP_U_EW (:)
TYPE (PTR2D), OPTIONAL :: YDGP_V_EW (:)
TYPE (PTR2D), OPTIONAL :: YDGP_S_EW (:)
TYPE (PTR2D), OPTIONAL :: YDGP_S_NS (:)
 ...
 & KVSETUV,KVSETSC)
  ...
  DO JBLK=1,IBLKS
    ...
    IF(IF_UV_G > 0 .AND. IF_SCALARS_G > 0) THEN
      CALL FTINV1_CTL(IF_UV_G,IF_SCALARS_G,&
...
ELSE
  ...
  CALL FTINV1_CTL(KF_UV_G,KF_SCALARS_G,&
   ...
   & YDGP_VOR=YDGP_VOR,YDGP_DIV=YDGP_DIV,YDGP_U=YDGP_U,&
   & YDGP_V=YDGP_V,YDGP_S=YDGP_S,YDGP_S_NS=YDGP_S_NS,YDGP_U_EW=YDGP_U_EW,&
   & YDGP_V_EW=YDGP_V_EW,YDGP_S_EW=YDGP_S_EW,YDGP=YDGP)
