...
SUBROUTINE INV_TRANS1_CTL(KF_GP,KF_FS,KF_OUT_LT,&
 ...
 & PSPVOR,PSPDIV,PSPSCALAR,FSPGL_PROC,&
...
INTEGER(KIND=JPIM) :: IOFFD,IOFFU,IOFFV,IOFFUVD,IOFFSC,IOFFSCNS,IOFFSCEW,IOFF
...
CALL FTINV1_CTL(KF_UV,KF_SCALARS,KF_SCDERS,KF_GP,KF_FS,KF_OUT_LT,YDGP=YDGP)
