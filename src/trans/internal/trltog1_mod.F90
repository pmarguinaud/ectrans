...
SUBROUTINE TRLTOG1(PGLAT,KF_FS,KF_GP,KF_SCALARS_G,KVSET,KPTRGP,&
...
CALL TRLTOG1_PROLOG(KF_FS,KF_GP,KVSET,&
...
IF (NSTACK_MEMORY_TR==0) THEN
  CALL TRLTOG1_COMM_HEAP(PGLAT,KF_FS,KF_GP,KF_SCALARS_G,KVSET, &
   & ISENDCOUNT,IRECVCOUNT,INSEND,INRECV,ISENDTOT,IRECVTOT,ISEND,IRECV,IINDEX,INDOFF,IGPTRSEND, &
   & KPTRGP,PGP,PGPUV,PGP3A,PGP3B,PGP2,&
   & ISETAL,ISETBL,ISETWL,ISETVL,YDGP)
ELSE
  CALL TRLTOG1_COMM_STACK(PGLAT,KF_FS,KF_GP,KF_SCALARS_G,KVSET, &
   & ISENDCOUNT,IRECVCOUNT,INSEND,INRECV,ISENDTOT,IRECVTOT,ISEND,IRECV,IINDEX,INDOFF,IGPTRSEND, &
   & KPTRGP,PGP,PGPUV,PGP3A,PGP3B,PGP2,&
   & ISETAL,ISETBL,ISETWL,ISETVL,YDGP)
ENDIF
...
SUBROUTINE TRLTOG1_PROLOG(KF_FS,KF_GP,KVSET,&
...
SUBROUTINE TRLTOG1_COMM_HEAP(PGLAT,KF_FS,KF_GP,KF_SCALARS_G,KVSET,&
 & KSENDCOUNT,KRECVCOUNT,KNSEND,KNRECV,KSENDTOT,KRECVTOT,KSEND,KRECV,KINDEX,KNDOFF,KGPTRSEND,&
 & KPTRGP,PGP,PGPUV,PGP3A,PGP3B,PGP2, &
...
CALL TRLTOG1_COMM(PGLAT,KF_FS,KF_GP,KF_SCALARS_G,KVSET,&
 & KSENDCOUNT,KRECVCOUNT,KNSEND,KNRECV,KSENDTOT,KRECVTOT,KSEND,KRECV,KINDEX,KNDOFF,KGPTRSEND,&
 & ZCOMBUFS,ZCOMBUFR, &
 & KPTRGP,PGP,PGPUV,PGP3A,PGP3B,PGP2, &
 & KSETAL, KSETBL,KSETWL,KSETVL,YDGP)
...
SUBROUTINE TRLTOG1_COMM_STACK(PGLAT,KF_FS,KF_GP,KF_SCALARS_G,KVSET,&
 & KSENDCOUNT,KRECVCOUNT,KNSEND,KNRECV,KSENDTOT,KRECVTOT,KSEND,KRECV,KINDEX,KNDOFF,KGPTRSEND,&
 & KPTRGP,PGP,PGPUV,PGP3A,PGP3B,PGP2, &
 & KSETAL, KSETBL,KSETWL,KSETVL,YDGP)
...
SUBROUTINE TRLTOG1_COMM(PGLAT,KF_FS,KF_GP,KF_SCALARS_G,KVSET,&
 & KSENDCOUNT,KRECVCOUNT,KNSEND,KNRECV,KSENDTOT,KRECVTOT,KSEND,KRECV,KINDEX,KNDOFF,KGPTRSEND,&
 & PCOMBUFS,PCOMBUFR, &
 & KPTRGP,PGP,PGPUV,PGP3A,PGP3B,PGP2, &
 & KSETAL, KSETBL,KSETWL,KSETVL,YDGP)
...
! IADDR1 = LOC (PGP3A(1,IGP3ALEVS(IFLD),IGP3APARS(IFLD),1))
! IADDR2 = LOC (YDGP (IFLD)%P (1, 1))
! IF (IADDR1 /= IADDR2) THEN
! WRITE (*, '(L1," ",I8," ",I8," ",I8," ",I8)') IADDR1 == IADDR2, IFLD, IGP3ALEVS(IFLD), IGP3APARS(IFLD), (IADDR2-IADDR1)/(8)
! IF (IADDR1 /= IADDR2) ISTOP = ISTOP + 1
! IF (ISTOP > 100) STOP
! STOP
! ENDIF
...
!             PGP3B(JK,IGP3BLEVS(IFLD),IGP3BPARS(IFLD),JBLK)=PGLAT(JFLD64,KINDEX(IPOS))
            ...
            ENDDO
          ELSE
            WRITE(NOUT,*)'TRLTOG1_MOD: ERROR',JFLD64,IFLD
            CALL ABORT_TRANS('TRLTOG1_MOD: ERROR')
          ENDIF
        ENDDO
!endif
