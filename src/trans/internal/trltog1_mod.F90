...
IF (NSTACK_MEMORY_TR==0) THEN
  CALL TRLTOG1_COMM_HEAP(PGLAT,KF_FS,KF_GP, &
   & YLCTX%ISENDCOUNT,YLCTX%IRECVCOUNT,YLCTX%INSEND,YLCTX%INRECV,YLCTX%ISENDTOT,YLCTX%IRECVTOT,YLCTX%ISEND,YLCTX%IRECV,YLCTX%IINDEX,YLCTX%INDOFF,YLCTX%IGPTRSEND, &
   & YLCTX%ISETAL,YLCTX%ISETBL,YLCTX%ISETWL,YLCTX%ISETVL,YDGP)
ELSE
  CALL TRLTOG1_COMM_STACK(PGLAT,KF_FS,KF_GP, &
   & YLCTX%ISENDCOUNT,YLCTX%IRECVCOUNT,YLCTX%INSEND,YLCTX%INRECV,YLCTX%ISENDTOT,YLCTX%IRECVTOT,YLCTX%ISEND,YLCTX%IRECV,YLCTX%IINDEX,YLCTX%INDOFF,YLCTX%IGPTRSEND, &
   & YLCTX%ISETAL,YLCTX%ISETBL,YLCTX%ISETWL,YLCTX%ISETVL,YDGP)
ENDIF
...
SUBROUTINE TRLTOG1_COMM_HEAP(PGLAT,KF_FS,KF_GP,&
...
CALL TRLTOG1_COMM(PGLAT,KF_FS,KF_GP,&
 & KSENDCOUNT,KRECVCOUNT,KNSEND,KNRECV,KSENDTOT,KRECVTOT,KSEND,KRECV,KINDEX,KNDOFF,KGPTRSEND,&
 & ZCOMBUFS,ZCOMBUFR, &
 & KSETAL, KSETBL,KSETWL,KSETVL,YDGP)
...
SUBROUTINE TRLTOG1_COMM_STACK(PGLAT,KF_FS,KF_GP,&
 & KSENDCOUNT,KRECVCOUNT,KNSEND,KNRECV,KSENDTOT,KRECVTOT,KSEND,KRECV,KINDEX,KNDOFF,KGPTRSEND,&
 & KSETAL, KSETBL,KSETWL,KSETVL,YDGP)
...
SUBROUTINE TRLTOG1_COMM(PGLAT,KF_FS,KF_GP,&
 & KSENDCOUNT,KRECVCOUNT,KNSEND,KNRECV,KSENDTOT,KRECVTOT,KSEND,KRECV,KINDEX,KNDOFF,KGPTRSEND,&
 & PCOMBUFS,PCOMBUFR, &
 & KSETAL, KSETBL,KSETWL,KSETVL,YDGP)
