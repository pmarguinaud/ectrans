...
DO JPASS = 1, 2
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3A)) THEN
    DO I = 1, SIZE (PSPSC3A,3)
      DO J = SIZE (KVSETSC3A)+1, 2*SIZE (KVSETSC3A)
        CALL ASSOC (PGP3A (:,J,I,:))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3B)) THEN
    DO I = 1, SIZE (PSPSC3B,3)
      DO J = SIZE (KVSETSC3B)+1, 2*SIZE (KVSETSC3B)
        CALL ASSOC (PGP3B (:,J,I,:))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3A)) THEN
    DO I = 1, SIZE (PSPSC3A,3)
      DO J = 2*SIZE (KVSETSC3A)+1, 3*SIZE (KVSETSC3A)
        CALL ASSOC (PGP3A (:,J,I,:))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3B)) THEN
    DO I = 1, SIZE (PSPSC3B,3)
      DO J = 2*SIZE (KVSETSC3B)+1, 3*SIZE (KVSETSC3B)
        CALL ASSOC (PGP3B (:,J,I,:))
      ENDDO
    ENDDO
  ENDIF
