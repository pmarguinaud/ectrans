...
DO JPASS = 1, 2
  ...
  IF (PRESENT (KVSETUV)) THEN
    ...
    IF (LVORGP) THEN
      DO J = 1, SIZE (KVSETUV)
        CALL ASSOC (ICOUNT_VOR, YLGP_VOR, PGPUV (:,J,I+1,:))
      ENDDO
      I = I + 1
    ENDIF
    IF (LDIVGP) THEN
      DO J = 1, SIZE (KVSETUV)
        CALL ASSOC (ICOUNT_DIV, YLGP_DIV, PGPUV (:,J,I+1,:))
      ENDDO
      I = I + 1
    ENDIF
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (ICOUNT_U, YLGP_U, PGPUV (:,J,I+1,:))
    ENDDO
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (ICOUNT_V, YLGP_V, PGPUV (:,J,I+2,:))
    ENDDO
  ENDIF

  IF (PRESENT (KVSETSC2)) THEN
    DO J = 1, SIZE (KVSETSC2)
      CALL ASSOC (ICOUNT_S, YLGP_S, PGP2 (:,J,:))
    ENDDO
  ENDIF
  ...
  IF (PRESENT (KVSETSC3A)) THEN
    DO I = 1, SIZE (PSPSC3A,3)
      DO J = 1, SIZE (KVSETSC3A)
        CALL ASSOC (ICOUNT_S, YLGP_S, PGP3A (:,J,I,:))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (PRESENT (KVSETSC3B)) THEN
    DO I = 1, SIZE (PSPSC3B,3)
      DO J = 1, SIZE (KVSETSC3B)
        CALL ASSOC (ICOUNT_S, YLGP_S, PGP3B (:,J,I,:))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC2)) THEN
    DO J = SIZE (KVSETSC2)+1, 2*SIZE (KVSETSC2)
      CALL ASSOC (ICOUNT_S_NS, YLGP_S_NS, PGP2 (:,J,:))
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3A)) THEN
    DO I = 1*SIZE (PSPSC3A,3)+1, 2*SIZE (PSPSC3A,3)
      DO J = 1, SIZE (KVSETSC3A)
        CALL ASSOC (ICOUNT_S_NS, YLGP_S_NS, PGP3A (:,J,I,:))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3B)) THEN
    DO I = 1*SIZE (PSPSC3B,3)+1, 2*SIZE (PSPSC3B,3)
      DO J = 1, SIZE (KVSETSC3B)
        CALL ASSOC (ICOUNT_S_NS, YLGP_S_NS, PGP3B (:,J,I,:))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LUVDER .AND. PRESENT (KVSETUV)) THEN
    ...
    IF (LDIVGP) I = I + 1
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (ICOUNT_U_EW, YLGP_U_EW, PGPUV (:,J,I+3,:))
    ENDDO
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (ICOUNT_V_EW, YLGP_V_EW, PGPUV (:,J,I+4,:))
    ENDDO
  ENDIF
  
  IF (LSCDERS .AND. PRESENT (KVSETSC2)) THEN
    DO J = 2*SIZE (KVSETSC2)+1, 3*SIZE (KVSETSC2)
      CALL ASSOC (ICOUNT_S_EW, YLGP_S_EW, PGP2 (:,J,:))
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3A)) THEN
    DO I = 2*SIZE (PSPSC3A,3)+1, 3*SIZE (PSPSC3A,3)
      DO J = 1, SIZE (KVSETSC3A)
        CALL ASSOC (ICOUNT_S_EW, YLGP_S_EW, PGP3A (:,J,I,:))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3B)) THEN
    DO I = 2*SIZE (PSPSC3B,3)+1, 3**SIZE (PSPSC3B,3)
      DO J = 1, SIZE (KVSETSC3B)
        CALL ASSOC (ICOUNT_S_EW, YLGP_S_EW, PGP3B (:,J,I,:))
      ENDDO
    ENDDO
  ENDIF
...
CALL INV_TRANS1_CTL(IF_UV_G,IF_SCALARS_G,IF_GP,IF_FS,IF_OUT_LT,&
 ...
 & YLGP_VOR, YLGP_DIV, YLGP_U, YLGP_V, YLGP_S, YLGP_S_NS, YLGP_U_EW, YLGP_V_EW, YLGP_S_EW, YLGP)
...
SUBROUTINE ASSOC (KCOUNT, YDGP, P)

INTEGER (KIND=JPIM) :: KCOUNT
