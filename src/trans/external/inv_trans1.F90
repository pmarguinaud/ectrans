...
! fields                                     derivatives
! SIZE (KVSETUV) * 2                         2*(SIZE (KVSETUV) * 2)
! SIZE (KVSETSC2)                            2*(SIZE (KVSETSC2))
! SIZE (KVSETSC3A)*SIZE (PSPSC3A,3)          2*(SIZE (KVSETSC3A)*SIZE (PSPSC3A,3))
! SIZE (KVSETSC3B)*SIZE (PSPSC3B,3)          2*(SIZE (KVSETSC3B)*SIZE (PSPSC3B,3))

IF (PRESENT (KVSETUV)) THEN
dump (SIZE (KVSETUV) * 2) 
dump (1*(SIZE (KVSETUV) * 2))
dump (UBOUND (PGPUV))
ENDIF
IF (PRESENT (KVSETSC2)) THEN
dump (SIZE (KVSETSC2)) 
dump (2*(SIZE (KVSETSC2)))
dump (UBOUND (PGP2))
ENDIF
IF (PRESENT (KVSETSC3A) .AND. PRESENT (PSPSC3A)) THEN
dump (SIZE (KVSETSC3A)*SIZE (PSPSC3A,3)) 
dump (2*(SIZE (KVSETSC3A)*SIZE (PSPSC3A,3)))
dump (UBOUND (PGP3A))
ENDIF
IF (PRESENT (KVSETSC3B) .AND. PRESENT (PSPSC3B)) THEN
dump (SIZE (KVSETSC3B)*SIZE (PSPSC3B,3)) 
dump (2*(SIZE (KVSETSC3B)*SIZE (PSPSC3B,3)))
dump (UBOUND (PGP3B))
ENDIF
