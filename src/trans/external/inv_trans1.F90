...
INTEGER :: JPASS, ICOUNTG, ICOUNTS, ICOUNTS_NS, IRANK_L
...
! VOR      :  2 * UBOUND (PSPDIV, 1)
! DIV      :  2 * UBOUND (PSPDIV, 1)
! U        :  2 * UBOUND (PSPDIV, 1)
! V        :  2 * UBOUND (PSPDIV, 1)
! 2        :  2 * UBOUND (PSPSC2, 1)
! 3A       :  2 * UBOUND (PSPSC3A, 1) * UBOUND (PSPSC3A, 3)
! 3B       :  2 * UBOUND (PSPSC3B, 1) * UBOUND (PSPSC3B, 3)
! 2   N/S  :  2 * UBOUND (PSPSC2, 1)
! 3A  N/S  :  2 * UBOUND (PSPSC3A, 1) * UBOUND (PSPSC3A, 3)
! 3B  N/S  :  2 * UBOUND (PSPSC3B, 1) * UBOUND (PSPSC3B, 3)
...
DO JPASS = 1, 2
  ...
  IF (PRESENT (KVSETUV)) THEN
    DO I = 1, SIZE (PSPVOR, 1) 
      CALL ASSOCS (NTYPE_VOR, PSPVOR (I, :))
    ENDDO
    DO I = 1, SIZE (PSPDIV, 1) 
      CALL ASSOCS (NTYPE_DIV, PSPDIV (I, :))
    ENDDO
    DO I = 1, SIZE (PSPVOR, 1) 
      CALL ASSOCS (NTYPE_U)
    ENDDO
  ...
  IF (PRESENT (KVSETSC2)) THEN
    DO I = 1, SIZE (PSPSC2, 1) 
      CALL ASSOCS (NTYPE_S, PSPSC2 (I, :), KPTR_NS=ICOUNTS_NS)
    ENDDO
  ENDIF
  ...
  IF (PRESENT (KVSETSC3A)) THEN
    DO J = 1, SIZE (PSPSC3A, 3)
      DO I = 1, SIZE (PSPSC3A, 1) 
        CALL ASSOCS (NTYPE_S, PSPSC3A (I, :, J), KPTR_NS=ICOUNTS_NS)
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (PRESENT (KVSETSC3B)) THEN
    DO J = 1, SIZE (PSPSC3B, 3)
      DO I = 1, SIZE (PSPSC3B, 1) 
        CALL ASSOCS (NTYPE_S, PSPSC3B (I, :, J), KPTR_NS=ICOUNTS_NS)
      ENDDO
    ENDDO
  ENDIF
...
! ! N/S derivatives
  IF (LSCDERS .AND. PRESENT (KVSETSC2)) THEN
    DO I = 1, SIZE (PSPSC2, 1) 
      CALL ASSOCS (IOR (NTYPE_S, NTYPE_NS))
    ENDDO
  ENDIF
...
SUBROUTINE ASSOCS (KTYPE, P, KPTR_NS)
