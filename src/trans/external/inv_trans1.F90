...
IC = ICOUNT + 1
    DO I = 1, 2
      DO J = 1, SIZE (KVSETUV)
        CALL ASSOC (PGPUV (:,J,I,:))
      ENDDO
    ENDDO
IF (ALLOCATED (YLGP)) WRITE (*, '(Z16.16," .. ",Z16.16," UV       ")')  LOC (YLGP (IC)%P(1,1)), LOC (YLGP (ICOUNT)%P(1,1))
  ENDIF
...
IC = ICOUNT + 1
    DO J = 1, SIZE (KVSETSC2)
      CALL ASSOC (PGP2 (:,J,:))
    ENDDO
IF (ALLOCATED (YLGP)) WRITE (*, '(Z16.16," .. ",Z16.16," 2        ")')  LOC (YLGP (IC)%P(1,1)), LOC (YLGP (ICOUNT)%P(1,1))
  ENDIF
...
IC = ICOUNT + 1
    DO I = 1, SIZE (PSPSC3A,3)
      DO J = 1, SIZE (KVSETSC3A)
        CALL ASSOC (PGP3A (:,J,I,:))
      ENDDO
    ENDDO
IF (ALLOCATED (YLGP)) WRITE (*, '(Z16.16," .. ",Z16.16," 3A       ")')  LOC (YLGP (IC)%P(1,1)), LOC (YLGP (ICOUNT)%P(1,1))
  ENDIF
...
IC = ICOUNT + 1
    DO I = 1, SIZE (PSPSC3B,3)
      DO J = 1, SIZE (KVSETSC3B)
        CALL ASSOC (PGP3B (:,J,I,:))
      ENDDO
    ENDDO
IF (ALLOCATED (YLGP)) WRITE (*, '(Z16.16," .. ",Z16.16," 3B       ")')  LOC (YLGP (IC)%P(1,1)), LOC (YLGP (ICOUNT)%P(1,1))
  ENDIF
...
IC = ICOUNT + 1
    DO J = SIZE (KVSETSC2)+1, 2*SIZE (KVSETSC2)
      CALL ASSOC (PGP2 (:,J,:))
    ENDDO
IF (ALLOCATED (YLGP)) WRITE (*, '(Z16.16," .. ",Z16.16," 2    N/S ")')  LOC (YLGP (IC)%P(1,1)), LOC (YLGP (ICOUNT)%P(1,1))
  ENDIF
...
IC = ICOUNT + 1
    DO I = 1*SIZE (PSPSC3A,3)+1, 2*SIZE (PSPSC3A,3)
      ...
      ENDDO
    ENDDO
IF (ALLOCATED (YLGP)) WRITE (*, '(Z16.16," .. ",Z16.16," 3A   N/S ")')  LOC (YLGP (IC)%P(1,1)), LOC (YLGP (ICOUNT)%P(1,1))
  ENDIF
...
IC = ICOUNT + 1
    DO I = 1*SIZE (PSPSC3B,3)+1, 2*SIZE (PSPSC3B,3)
      ...
      ENDDO
    ENDDO
IF (ALLOCATED (YLGP)) WRITE (*, '(Z16.16," .. ",Z16.16," 3B   N/S ")')  LOC (YLGP (IC)%P(1,1)), LOC (YLGP (ICOUNT)%P(1,1))
  ENDIF
...
IC = ICOUNT + 1
    DO I = 3, 4
      ...
      ENDDO
    ENDDO
IF (ALLOCATED (YLGP)) WRITE (*, '(Z16.16," .. ",Z16.16," UV   E/W ")')  LOC (YLGP (IC)%P(1,1)), LOC (YLGP (ICOUNT)%P(1,1))
  ENDIF
...
IC = ICOUNT + 1
    DO J = 2*SIZE (KVSETSC2)+1, 3*SIZE (KVSETSC2)
      CALL ASSOC (PGP2 (:,J,:))
    ENDDO
IF (ALLOCATED (YLGP)) WRITE (*, '(Z16.16," .. ",Z16.16," 2    E/W ")')  LOC (YLGP (IC)%P(1,1)), LOC (YLGP (ICOUNT)%P(1,1))
  ENDIF
...
IC = ICOUNT + 1
    DO I = 2*SIZE (PSPSC3A,3)+1, 3*SIZE (PSPSC3A,3)
      ...
      ENDDO
    ENDDO
IF (ALLOCATED (YLGP)) WRITE (*, '(Z16.16," .. ",Z16.16," 3A   E/W ")')  LOC (YLGP (IC)%P(1,1)), LOC (YLGP (ICOUNT)%P(1,1))
  ENDIF
...
IC = ICOUNT + 1
    DO I = 2*SIZE (PSPSC3B,3)+1, 3**SIZE (PSPSC3B,3)
      ...
      ENDDO
    ENDDO
IF (ALLOCATED (YLGP)) WRITE (*, '(Z16.16," .. ",Z16.16," 3B   E/W ")')  LOC (YLGP (IC)%P(1,1)), LOC (YLGP (ICOUNT)%P(1,1))
  ENDIF
