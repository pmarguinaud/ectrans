...
DO JPASS = 1, 2
  ...
  IF (PRESENT (KVSETUV)) THEN
    ...
    IF (LVORGP) THEN
      DO J = 1, SIZE (KVSETUV)
        CALL ASSOC (PGPUV (:,J,I+1,:), NTYPE_VOR, KVSETUV (J))
      ENDDO
      I = I + 1
    ENDIF
    IF (LDIVGP) THEN
      DO J = 1, SIZE (KVSETUV)
        CALL ASSOC (PGPUV (:,J,I+1,:), NTYPE_DIV, KVSETUV (J))
      ENDDO
      I = I + 1
    ENDIF
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (PGPUV (:,J,I+1,:), NTYPE_U, KVSETUV (J))
    ENDDO
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (PGPUV (:,J,I+2,:), NTYPE_V, KVSETUV (J))
    ENDDO
  ENDIF

  IF (PRESENT (KVSETSC2)) THEN
    DO J = 1, SIZE (KVSETSC2)
      CALL ASSOC (PGP2 (:,J,:), NTYPE_S, KVSETSC2 (J))
    ENDDO
  ENDIF
  ...
  IF (PRESENT (KVSETSC3A)) THEN
    DO I = 1, SIZE (PSPSC3A,3)
      DO J = 1, SIZE (KVSETSC3A)
        CALL ASSOC (PGP3A (:,J,I,:), NTYPE_S, KVSETSC3A (J))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (PRESENT (KVSETSC3B)) THEN
    DO I = 1, SIZE (PSPSC3B,3)
      DO J = 1, SIZE (KVSETSC3B)
        CALL ASSOC (PGP3B (:,J,I,:), NTYPE_S, KVSETSC3B (J))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC2)) THEN
    DO J = SIZE (KVSETSC2)+1, 2*SIZE (KVSETSC2)
      CALL ASSOC (PGP2 (:,J,:), IOR (NTYPE_S, NTYPE_NS), KVSETSC2 (J-SIZE (KVSETSC2)))
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3A)) THEN
    DO I = 1*SIZE (PSPSC3A,3)+1, 2*SIZE (PSPSC3A,3)
      DO J = 1, SIZE (KVSETSC3A)
        CALL ASSOC (PGP3A (:,J,I,:), IOR (NTYPE_S, NTYPE_NS), KVSETSC3A (J))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3B)) THEN
    DO I = 1*SIZE (PSPSC3B,3)+1, 2*SIZE (PSPSC3B,3)
      DO J = 1, SIZE (KVSETSC3B)
        CALL ASSOC (PGP3B (:,J,I,:), IOR (NTYPE_S, NTYPE_NS), KVSETSC3B (J))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LUVDER .AND. PRESENT (KVSETUV)) THEN
    ...
    IF (LDIVGP) I = I + 1
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (PGPUV (:,J,I+3,:), IOR (NTYPE_U, NTYPE_EW), KVSETUV (J))
    ENDDO
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (PGPUV (:,J,I+4,:), IOR (NTYPE_V, NTYPE_EW), KVSETUV (J))
    ENDDO
  ENDIF
  
  IF (LSCDERS .AND. PRESENT (KVSETSC2)) THEN
    DO J = 2*SIZE (KVSETSC2)+1, 3*SIZE (KVSETSC2)
      CALL ASSOC (PGP2 (:,J,:), IOR (NTYPE_S, NTYPE_EW), KVSETSC2 (J-2*SIZE (KVSETSC2)))
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3A)) THEN
    DO I = 2*SIZE (PSPSC3A,3)+1, 3*SIZE (PSPSC3A,3)
      DO J = 1, SIZE (KVSETSC3A)
        CALL ASSOC (PGP3A (:,J,I,:), IOR (NTYPE_S, NTYPE_EW), KVSETSC3A (J))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3B)) THEN
    DO I = 2*SIZE (PSPSC3B,3)+1, 3**SIZE (PSPSC3B,3)
      DO J = 1, SIZE (KVSETSC3B)
        CALL ASSOC (PGP3B (:,J,I,:), IOR (NTYPE_S, NTYPE_EW), KVSETSC3B (J))
      ENDDO
    ENDDO
  ENDIF
...
SUBROUTINE ASSOC (P, KTYPE, KVSET)
...
IF (ALLOCATED (YLGP)) THEN
  ...
  YLGP (ICOUNT)%IVSET = KVSET
  YLGP (ICOUNT)%IRANK_G = ICOUNT
  IF (KVSET == MYSETV) THEN
    IRANK_L = IRANK_L + 1
    YLGP (ICOUNT)%IRANK_L = IRANK_L
  ENDiF
ENDIF
