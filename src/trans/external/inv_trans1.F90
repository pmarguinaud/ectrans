...
DO JPASS = 1, 2
  ...
  IF (PRESENT (KVSETUV)) THEN
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (ICOUNT_U, YLGP_U, PGPUV (:,J,1,:))
    ENDDO
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (ICOUNT_V, YLGP_V, PGPUV (:,J,2,:))
    ENDDO
  ENDIF
  ...
  IF (LUVDER .AND. PRESENT (KVSETUV)) THEN
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (ICOUNT_U_EW, YLGP_U_EW, PGPUV (:,J,3,:))
    ENDDO
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (ICOUNT_V_EW, YLGP_V_EW, PGPUV (:,J,4,:))
    ENDDO
  ENDIF
...
YLGP = [YLGP_U, YLGP_V, YLGP_S, YLGP_S_NS, YLGP_U_EW, YLGP_V_EW, YLGP_S_EW]
