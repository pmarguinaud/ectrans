...
DO J = 1, SIZE (YLGP)
  WRITE (100+MYPROC, '(I8," ",I8," ",I8," ",I8," ",A8," ",A8)', ADVANCE='NO') &
 & J, YLGP (J)%IRANK_G, YLGP (J)%IRANK_L, YLGP (J)%IVSET, CFTYPE (YLGP (J)%ITYPE), YLGP (J)%CLNAME
...
DO J = 1, SIZE (YLSP)
  WRITE (100+MYPROC, '(I8," ",I8," ",I8," ",A8," ",A8," ",L1)', ADVANCE='NO') &
       & J, YLSP (J)%IPTR, YLSP (J)%IPTR_NS, CFTYPE (YLSP (J)%ITYPE), YLSP (J)%CLNAME, ASSOCIATED (YLSP (J)%P)
...
SUBROUTINE CLEARG (YDGP)

TYPE (PTRG), ALLOCATABLE :: YDGP (:)

IF (ALLOCATED (YDGP)) DEALLOCATE (YDGP)
ALLOCATE (YDGP (0))
