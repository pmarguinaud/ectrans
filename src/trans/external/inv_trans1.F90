...
DO JPASS = 1, 2
  ...
  IF (PRESENT (KVSETUV)) THEN
    ...
    IF (LVORGP) THEN
      DO J = 1, SIZE (KVSETUV)
        CALL ASSOC (PGPUV (:,J,I+1,:), NPTR_VOR, KVSETUV (J))
      ENDDO
      I = I + 1
    ENDIF
    IF (LDIVGP) THEN
      DO J = 1, SIZE (KVSETUV)
        CALL ASSOC (PGPUV (:,J,I+1,:), NPTR_DIV, KVSETUV (J))
      ENDDO
      I = I + 1
    ENDIF
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (PGPUV (:,J,I+1,:), NPTR_U, KVSETUV (J))
    ENDDO
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (PGPUV (:,J,I+2,:), NPTR_V, KVSETUV (J))
    ENDDO
  ENDIF

  IF (PRESENT (KVSETSC2)) THEN
    DO J = 1, SIZE (KVSETSC2)
      CALL ASSOC (PGP2 (:,J,:), NPTR_S, KVSETSC2 (J))
    ENDDO
  ENDIF
  ...
  IF (PRESENT (KVSETSC3A)) THEN
    DO I = 1, SIZE (PSPSC3A,3)
      DO J = 1, SIZE (KVSETSC3A)
        CALL ASSOC (PGP3A (:,J,I,:), NPTR_S, KVSETSC3A (J))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (PRESENT (KVSETSC3B)) THEN
    DO I = 1, SIZE (PSPSC3B,3)
      DO J = 1, SIZE (KVSETSC3B)
        CALL ASSOC (PGP3B (:,J,I,:), NPTR_S, KVSETSC3B (J))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC2)) THEN
    DO J = SIZE (KVSETSC2)+1, 2*SIZE (KVSETSC2)
      CALL ASSOC (PGP2 (:,J,:), IOR (NPTR_S, NPTR_NS), KVSETSC2 (J-SIZE (KVSETSC2)))
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3A)) THEN
    DO I = 1*SIZE (PSPSC3A,3)+1, 2*SIZE (PSPSC3A,3)
      DO J = 1, SIZE (KVSETSC3A)
        CALL ASSOC (PGP3A (:,J,I,:), IOR (NPTR_S, NPTR_NS), KVSETSC3A (J))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3B)) THEN
    DO I = 1*SIZE (PSPSC3B,3)+1, 2*SIZE (PSPSC3B,3)
      DO J = 1, SIZE (KVSETSC3B)
        CALL ASSOC (PGP3B (:,J,I,:), IOR (NPTR_S, NPTR_NS), KVSETSC3B (J))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LUVDER .AND. PRESENT (KVSETUV)) THEN
    ...
    IF (LDIVGP) I = I + 1
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (PGPUV (:,J,I+3,:), IOR (NPTR_U, NPTR_EW), KVSETUV (J))
    ENDDO
    DO J = 1, SIZE (KVSETUV)
      CALL ASSOC (PGPUV (:,J,I+4,:), IOR (NPTR_V, NPTR_EW), KVSETUV (J))
    ENDDO
  ENDIF
  
  IF (LSCDERS .AND. PRESENT (KVSETSC2)) THEN
    DO J = 2*SIZE (KVSETSC2)+1, 3*SIZE (KVSETSC2)
      CALL ASSOC (PGP2 (:,J,:), IOR (NPTR_S, NPTR_EW), KVSETSC2 (J-2*SIZE (KVSETSC2)))
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3A)) THEN
    DO I = 2*SIZE (PSPSC3A,3)+1, 3*SIZE (PSPSC3A,3)
      DO J = 1, SIZE (KVSETSC3A)
        CALL ASSOC (PGP3A (:,J,I,:), IOR (NPTR_S, NPTR_EW), KVSETSC3A (J))
      ENDDO
    ENDDO
  ENDIF
  ...
  IF (LSCDERS .AND. PRESENT (KVSETSC3B)) THEN
    DO I = 2*SIZE (PSPSC3B,3)+1, 3**SIZE (PSPSC3B,3)
      DO J = 1, SIZE (KVSETSC3B)
        CALL ASSOC (PGP3B (:,J,I,:), IOR (NPTR_S, NPTR_EW), KVSETSC3B (J))
      ENDDO
    ENDDO
  ENDIF
...
SUBROUTINE ASSOC (P, KIND, KVSET)

INTEGER (KIND=JPIM) :: KIND, KVSET
